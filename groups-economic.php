<?php
	...
	$patterns = json_decode(file_get_contents(__DIR__ . '/economic.json'));
	$positives = array();
	$negatives = array();
	...
	$map = merge(map($keywords, $negatives, 100, 30), map($keywords, $negatives, 400, 80));
	...
	file_put_contents(__DIR__ . '/groups/economic.json', json_encode($groups));
	...
	file_put_contents(__DIR__ . '/groups/economic-morning.json', json_encode($groups2));
	file_put_contents(__DIR__ . '/groups/economic-evening.json', json_encode($groups3));
	...
	file_put_contents(__DIR__ . '/groups/economic-negative.json', json_encode($groups));
	...
	file_put_contents(__DIR__ . '/groups/economic-negative-morning.json', json_encode($groups2));
	file_put_contents(__DIR__ . '/groups/economic-negative-evening.json', json_encode($groups3));
